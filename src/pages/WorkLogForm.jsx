                ...
                <div key={idx} style={{
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                    <div className="form-group" style={{ margin: 0, flex: '0 0 110px' }}>
                      <label style={{ fontSize: '12px' }}>מספר עובדים</label>
                  ...
                  {entry.category && workers > 0 && (
                    <div style={{
                      ...
                      fontSize: '12px', color: 'var(--gold)', display: 'flex', justifyContent: 'space-between'
                    }}>
                      <span>
                        {workers} עובדים × {formatCurrency(catCost ? catCost.clientPrice : settings.laborCostPerWorker)} ליום
                      </span>
