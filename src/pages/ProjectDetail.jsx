...
import { getProject, getQuote, getMilestones } from '../data/store'
...
export default function ProjectDetail() {
  ...
  const totals = quote ? calcQuoteTotals(quote.items || []) : { totalCost: 0, totalSell: 0, profit: 0, profitMargin: 0 }
  const projMilestones = getMilestones().filter(m => m.projectId === pid)
