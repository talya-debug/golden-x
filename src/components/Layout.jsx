...
function Logo() {
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontSize: '16px', fontWeight: 700, color: 'var(--gold)' }}>Golden X</div>
        <div style={{ fontSize: '11px', color: 'var(--text-muted)', letterSpacing: '1px' }}>PROJECTS</div>
      </div>
    </div>
  )
}
